...
\definecolor{crimson}{RGB}{205,60,83}
\definecolor{clay}{RGB}{247,245,245}

\setbeamercolor{normal text}{fg=black,bg=clay}
\setbeamercolor{alerted text}{fg=crimson}
\setbeamercolor{example text}{fg=crimson!50!black}

\setbeamercolor{structure}{fg=crimson!30!black, bg=crimson!90!black}

\setbeamercolor{background canvas}{parent=normal text}
\setbeamercolor{background}{parent=background canvas}

\setbeamercolor{palette primary}{fg=clay, bg=crimson!70!clay}
\setbeamercolor{palette secondary}{use=structure,fg=structure.fg!50!white, bg=crimson}
\setbeamercolor{palette tertiary}{use=structure,fg=structure.fg!0!white, bg=crimson!50!white} 
